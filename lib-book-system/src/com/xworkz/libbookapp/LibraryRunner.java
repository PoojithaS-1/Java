...
public class LibraryRunner {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("7.get Price By BookId");
            System.out.println("8.get BookName By BookAuthor");
            System.out.println("9.update BookAuthor By BookName");
            System.out.println("10.update Price And BookName By Id");
            ...
            switch (option){
                ...
                case 7:
                    System.out.println("Enter the BookId: ");
                    collegeLibrary.getPriceById(scanner.nextInt());
                    break;
                case 8:
                    System.out.println("Enter authorName: ");
                    collegeLibrary.getBookNameByBookAuthor(scanner.next());
                    break;
                case 9:
                ...
                case 10:
                    ...
                    collegeLibrary.getDetails();
                    collegeLibrary.updatePriceAndBookNameByid(id,updatedPrice,updatedBookName);
                    collegeLibrary.getDetails();
                    break;
                case 11:
