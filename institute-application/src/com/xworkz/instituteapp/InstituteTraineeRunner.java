...
public class InstituteTraineeRunner {
    public static void main(String[] args) {
        ...
        institute.getGenderByName("Poornima");

        institute.getNameByGender(GenderType.FEMALE);

        institute.getPhoneNumberByName("Kavana");

        institute.getEmailByName("Kavya");

        institute.getEmailById(6);

        institute.getDobById(4);

        institute.getDegreeNameByName("Poorna");

        institute.getYearOfGraduationByDegreeName("MCA");

        institute.updateEmailById(2,"poornaa@gmail.com");

        institute.updatePhoneNumberByName("Poojitha",9980604600l);

        institute.updateisPlacedByName("Poojitha",true);
